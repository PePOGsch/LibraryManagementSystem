...
{
    [Authorize] // Dostęp tylko dla administratora
    public class BooksController : Controller
    {
        ...
        [Authorize(Roles = "Administrator")]
        public async Task<IActionResult> Create([Bind("Title,Author,ISBN,Genre,Description,PublisherLink,AvailableCopies")] Book book)
        {
